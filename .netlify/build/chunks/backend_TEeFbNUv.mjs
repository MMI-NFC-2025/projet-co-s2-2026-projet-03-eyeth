...
async function getPacks(collection = "packs") {
    try {
...
async function getMotsForPack(packId) {
    try {
...
async function getOneMot(idMot) {
    try {
...
export { getMots as a, getMotsForPack as b, getPacks as c, getOneMot as g, onePack as o, pb as p };
